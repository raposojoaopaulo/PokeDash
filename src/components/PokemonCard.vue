...
export default {
  ...
  computed: {
    ...
    externalLink() {
      return (`https://bulbapedia.bulbagarden.net/wiki/${this.pokemon.name}_(Pokémon)`);
    },
...
<template>
  <div class="pokemoncard">
    <div class="pokemoncard__img">
      <a :href="externalLink" target="_blank" :title="`Click here for more information about ${this.pokemon.name}`">
    ...
    <div class="pokemoncard__info">
      ...
      <div class="pokemoncard__info__stats">
        <div class="pokemoncard__info__stats__item">
          <p>{{ formattedWord(pokemon.stats[0].stat.name) }}:</p>
        ...
        <div class="pokemoncard__info__stats__item">
          <p>{{ formattedWord(pokemon.stats[1].stat.name) }}:</p>
        ...
        <div class="pokemoncard__info__stats__item">
          <p>{{ formattedWord(pokemon.stats[2].stat.name) }}:</p>
        ...
        <div class="pokemoncard__info__stats__item">
          <p>{{ formattedWord(pokemon.stats[3].stat.name) }}:</p>
        ...
        <div class="pokemoncard__info__stats__item">
          <p>{{ formattedWord(pokemon.stats[4].stat.name) }}:</p>
        ...
        <div class="pokemoncard__info__stats__item">
          <p>{{ formattedWord(pokemon.stats[5].stat.name) }}:</p>
